...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-[100dvh] w-full flex">
      ...
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-[52%] relative z-10">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div className="max-w-xl mt-8">
            ...
            <p className="text-lg text-muted-foreground/85 leading-relaxed max-w-lg font-medium">
              Explora um sistema de inteligência artificial que pensa, sente e
              aprende contigo.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-border/30">
              <div className="text-sm text-muted-foreground/70">
                ©
                Filipe Alexandre Judicibus Alcaide, Nº.2023394, Licenciatura
                em Engenharia Informática, Ano Letivo 2025/2026, ISTEC Lisboa.
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Right side - Form */}
      <div className="w-full lg:w-[48%] flex flex-col items-center justify-center p-6 sm:p-8 relative z-10">
